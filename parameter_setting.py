...
def parse_args():
    ...
    parser.add_argument('--n_head', type=int, default=1,help='the number of multihead')
    parser.add_argument('--k_blocks', type=int, default=1,help='the block of self-attention')
    parser.add_argument('--GCN_drop_out', type=float, default=0.5,help='the droup out rate of GCN')
    parser.add_argument('--SA_drop_out', type=float, default=0.5,help='the droup out rate of residual network ')
    parser.add_argument('--tune_epochs', type=int, default=50,help='tune num')
    parser.add_argument('--score_metric', type=str, default='NDCG10', help='use which metric to define hyperopt score')
